  ...
  const defaulttitlecards =[
    ...
    {titlecard: 'Crear un Ticket Nuevo', subtitlecard:'', iconcard:'https://cdn-icons-gif.flaticon.com/7994/7994402.gif', linkcard: '/PQRS', iconStcard: 'https://cdn-icons-png.flaticon.com/512/7994/7994402.png'},
    {titlecard: 'Tickets de Soporte o Servicio', subtitlecard:'', iconcard:'https://cdn-icons-gif.flaticon.com/7211/7211799.gif', linkcard: '/todos', iconStcard: 'https://cdn-icons-png.flaticon.com/512/7211/7211799.png'},
    ...
    {titlecard: 'Lista General de Clientes', subtitlecard:'', iconcard:'https://cdn-icons-gif.flaticon.com/7211/7211817.gif', linkcard: '/Costumer', iconStcard: 'https://cdn-icons-png.flaticon.com/512/7211/7211817.png'},
  ...
  const defaulttitleleftbarra =[
    ...
    {leftoption: 'Registrar Usuarios', iconleft: 'https://cdn-icons-gif.flaticon.com/7931/7931421.gif', linkleft: '/PQRS',iconSTleft: Todoimg},
    {leftoption: 'Lista de Usuarios', iconleft: 'https://cdn-icons-gif.flaticon.com/8819/8819071.gif', linkleft: '/Costumer',iconSTleft: Todoimg},
  ...
  const defaultPQRS =[
    ...
    {titlePQRS: 'Evidencias'}, 
    {titlePQRS: 'Reportado por'},
    {titlePQRS: 'No Ticket'},
    {titlePQRS: 'Estado'},
    {titlePQRS: 'Fecha de Reporte'},
    {titlePQRS: 'Requerimientos'},
    {titlePQRS: 'Avances'},
    {titlePQRS: 'Solución'},
    {titlePQRS: 'Horas de Trabajo'},
    {titlePQRS: 'Valor Hora'},
    {titlePQRS: 'Valor Total'},
    {titlePQRS: 'Fecha de Solución'},
    {titlePQRS: 'Fecha de Cierre'},
  ]  
  
  export {defaultPQRS};

  const defaultCostumer =[
    {titleCostumer: 'Codigo de Cliente'},
    {titleCostumer: 'Nombre del Cliente o Empresa'},
    {titleCostumer: 'NIT o CC'},
    {titleCostumer: 'Representante Legal'},
    {titleCostumer: 'Contacto'},
    {titleCostumer: 'Ciudad'},
    {titleCostumer: 'Dirección'},
